...
const initialItems: FileSystemItem[] = [
  ...
  { id: 'ago-study', parentId: SYSTEM_FOLDERS.DESKTOP, name: 'AGO Digital Experience - UX Research Case Study.pdf', type: 'file', kind: 'pdf', dateModified: new Date(), content: '/AGO Digital Experience - UX Research Case Study.pdf', isSystem: false },
