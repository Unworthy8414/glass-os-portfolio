...
import { Monitor, Menu, X, ChevronDown, FileText, Clock3, Grid, Download } from 'lucide-react';
...
// Case studies data for the dropdown
            ...
            <AnimatePresence>
              {workDropdownOpen && (
                <motion.div
                  ...
                  className="absolute top-full left-0 mt-2 w-64 bg-slate-800/95 backdrop-blur-xl rounded-xl border border-white/10 shadow-xl overflow-hidden"
                >
                  <div className="p-2">
                    <button
                    ...
                    {caseStudies.map((study) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-sm font-medium text-white/90 group-hover:text-white">{study.title}</div>
                            <div className="text-xs text-white/50">{study.subtitle}</div>
                          </div>
                        </div>
                      </button>
                    ))}
