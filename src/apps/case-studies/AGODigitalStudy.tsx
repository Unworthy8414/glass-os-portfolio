                    ...
                    <div className="space-y-16">
                        ...
                        >
                            ...
                            <div className="space-y-8">
                                <header className="border-b border-white/10 pb-6">
                                    <h1 className={`${isCompact ? 'text-2xl' : 'text-3xl'} font-semibold mb-3 text-white/90`}>Art Gallery of Ontario: Digital Purchase Journey</h1>
                                ...
                                <div className="bg-white/5 p-5 rounded-lg border border-white/10">
                                    <h4 className="font-medium text-white/80 mb-3 flex items-center gap-2 text-sm">
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h3 className="text-lg font-semibold text-white/90">Competitive Analysis & Heuristic Evaluation</h3>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h3 className="text-lg font-semibold text-white/90">User Interviews</h3>
                                    </div>
                                    <p className="text-sm text-white/50">
                                    ...
                                    <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                        ...
                                        <div className={`grid gap-2 text-xs ${isCompact ? 'grid-cols-1' : 'grid-cols-2'}`}>
                                            {[
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h3 className="text-lg font-semibold text-white/90">Ethnographic Research</h3>
                                    </div>
                                    <p className="text-sm text-white/50">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xs font-medium uppercase tracking-wider" style={{ color: glassos.yellow }}>03 / Findings</h2>
                            </div>

                            <div className="space-y-8">
                                <div>
                                    <h3 className="text-xl font-semibold mb-4 text-white/90">Key Findings: Purchase Journey Pain Points</h3>
                                    <div className={`grid gap-4 ${isCompact ? 'grid-cols-1' : 'grid-cols-2'}`}>
                                        {[
                                            {
                                            ...
                                            <div key={i} className="bg-white/5 p-4 rounded-lg border border-white/10">
                                                <h4 className="font-medium mb-2 text-sm" style={{ color: finding.color }}>{finding.title}</h4>
                                ...
                                <div className="backdrop-blur-sm p-6 rounded-xl border border-white/10" style={{ background: 'linear-gradient(135deg, rgba(30,30,46,0.8), rgba(20,20,35,0.8))' }}>
                                    <div className="flex items-center justify-between mb-4">
                                        <h3 className="text-lg font-semibold text-white/90">User Journey Map: AGO Purchase Path</h3>
                                        <span className="text-[10px] text-white/40">Persona: Jessica</span>
                                    </div>
                                    <div className="relative border-l pl-6 space-y-5" style={{ borderColor: `${glassos.pink}4D` }}>
                                        {[
                                ...
                                <div className="p-5 rounded-lg border" style={{ backgroundColor: `${glassos.teal}1A`, borderColor: `${glassos.teal}33` }}>
                                    <h4 className="font-medium mb-2 flex items-center gap-2 text-sm" style={{ color: glassos.teal }}>
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xs font-medium uppercase tracking-wider" style={{ color: glassos.pink }}>04 / Recommendations</h2>
                            </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-white/5 p-5 rounded-lg border border-white/10">
                                    <h4 className="font-medium text-sm mb-3 text-white/80">Quick Wins (High Impact, Low Effort)</h4>
                                    <div className={`grid gap-3 ${isCompact ? 'grid-cols-1' : 'grid-cols-3'}`}>
                                        {[
                        ...
                        >
                            ...
                            <div className="space-y-8">
                                ...
                                <div className={`grid gap-6 ${isCompact ? 'grid-cols-1' : 'grid-cols-2'}`}>
                                    <div>
                                        <h4 className="font-medium text-sm mb-3 text-white/90">Methodology Highlights</h4>
                                        <div className="space-y-3">
